-- ============================================================
-- crm_inbox_view v2: remove v1 UNION (visitor_chat_sessions)
-- Only conversations (v2) in CHATS section.
-- Uses denormalized fields: last_message_content, message_count, unread_count
...
-- ═══ CHATS (conversations only — v1 visitor_chat_sessions removed) ═══
SELECT
    (s.id)::text AS id,
    'chat'::text AS type,
...
\echo '✅ crm_inbox_view v2: visitor_chat_sessions removed, conversations only'
