-- Use linked account phone in chat inbox rows when contact/session phone is empty.
...
INSERT INTO public.crm_inbox (type, id, client_name, client_phone, preview, status, priority, sort_time, channel, assigned_to, assigned_to_name, unread, metadata, updated_at)
